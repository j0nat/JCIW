...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        {
            ImGuiNative.igSetMousePos(x, y);
        }
        public static void MouseDown(int down)
        {
            ImGuiNative.igSetMouseDown(down);
        }
        public static void KeyDown(int key, int down)
        {
            ImGuiNative.igSetKeyDown(key, down);
        }
        public static int KeyboardWanted()
        {
            return ImGuiNative.igIsKeyboardWanted();
        }
