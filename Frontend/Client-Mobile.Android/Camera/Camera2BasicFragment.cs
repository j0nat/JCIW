...
using Client_Mobile.Android.Listeners;
using Java.IO;
using Java.Lang;
using Java.Util;
...
namespace Client_Mobile.Android
{
    public class Camera2BasicFragment : Fragment, View.IOnClickListener, FragmentCompat.IOnRequestPermissionsResultCallback
    {
        ...
        //    CameraManager manager = Activity.GetSystemService(Context.CameraService);
        ...
        private void SetUpCameraOutputs(int width, int height)
        {
            ...
            try
            {
                for (var i = 0; i < manager.GetCameraIdList().Length; i++)
                {
                    ...
                    mImageReader = ImageReader.NewInstance(largest.Width / 5, largest.Height / 5, ImageFormatType.Jpeg, /*maxImages*/1);
            ...
            catch (NullPointerException e)
            {
                ...
                ErrorDialog.NewInstance("2").Show(ChildFragmentManager, FRAGMENT_DIALOG);
            }
        }
        ...
        {
            int rotation = (int)this.Activity.WindowManager.DefaultDisplay.Rotation;
            Intent intent = new Intent();
            intent.PutExtra("width", mImageReader.Width);
            intent.PutExtra("height", mImageReader.Height);
