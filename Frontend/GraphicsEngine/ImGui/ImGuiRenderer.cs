...
namespace GraphicsEngine.ImGuiMonoGame
{
    /// <summary>
    ...
    public class ImGuiRenderer
    {
        ...
        private IPlatformFunctions platformFunctions;
        ...
        protected virtual void SetupInput()
        {
            ...
            {
                platformFunctions.RegisterDesktopKeyboardInput(_game);
        ...
        protected virtual void UpdateInput()
        {
            ...
            if (platform == Platform.Android)
            {
                if (mobileKeyBackspace)
                {
                    ImGui.KeyDown(8, 1);
                    mobileKeyBackspace = false;
                }
                else
                {
                    ImGui.KeyDown(8, 0);
            ...
            io.DisplaySize = new JCIW.Data.Drawing.Vector2(_graphicsDevice.PresentationParameters.BackBufferWidth, _graphicsDevice.PresentationParameters.BackBufferHeight);
            io.DisplayFramebufferScale = new JCIW.Data.Drawing.Vector2(1f, 1f);
            ...
            if (platform == Platform.Android)
            {
                ...
                Vector2 outMouse;
                if (GetPressed(out outMouse))
                {
                    ImGui.MousePos((int)outMouse.X, (int)outMouse.Y);
                    ImGui.MouseDown(1);
                }
                else
                {
            ...
            {
                io.MousePos = new JCIW.Data.Drawing.Vector2(mouse.X, mouse.Y);
        ...
        public bool GetPressed(out Vector2 touchPosition)
        {
        ...
        private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
        {
            ...
            for (int n = 0; n < drawData.CmdListsCount; n++)
            {
                ...
                {
                    void* source = (void*)cmdList.VtxBuffer.Data;
                    void* destination = vtxDstPtr;
                    Int64 destinationSizeInBytes = _vertexData.Length;
                    Int64 sourceBytesToCopy = cmdList.VtxBuffer.Size * DrawVertDeclaration.Size;

                    Unsafe.CopyBlock(destination, source, (uint)sourceBytesToCopy);


                    void* source2 = (void*)cmdList.IdxBuffer.Data;
                    void* destination2 = idxDstPtr;
                    Int64 destinationSizeInBytes2 = _indexData.Length;
                    Int64 sourceBytesToCopy2 = cmdList.IdxBuffer.Size * sizeof(ushort);

                    Unsafe.CopyBlock(destination2, source2, (uint)sourceBytesToCopy2);
                }
